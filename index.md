...
3. <span id="核聚变">**核聚变**</span>(托卡马克/仿星器/Z箍缩/惯性约束)
   ...
   3. <span id="重核聚变">**重核聚变**</span>(非常规型核聚变，包括CNO循环和其他原子序数小于铁的元素的聚变，*0.7%<ε<1%*)
...
13. <span id="核聚变推进器">**核聚变推进器**</span>(*50000s<I<sub>sp</sub><0.14c/g*）
    1. **磁-惯性约束核聚变**
    2. **Z箍缩**
14. **电磁场构型推进器**(完全运用电磁场在飞船外对燃料和反应进行操纵，将反应过程完全置于飞船外，通过喷流等离子体与电磁场的作用推动飞船前进。可以避开材料限制，获得极大的功率。这种构型的推进器在运行时看上去就像魔法一样。)
...
18. <span id="纯质能转化火箭推进器">**纯质能转化火箭推进器**</span>(*I<sub>sp</sub>=1c/g*)
...
50. **“行星工程”**(完全城市化并改造地球陆地，海洋，和内部)
51. <span id="行星发动机">**行星发动机**</span>(用于推动行星大小固态物质的推进器，能量来源不限，可使用任何质能转化方式)
52. **气态行星人造殖民地**(与[气态行星太空城](#气态行星太空城)相似，气态行星大气中建造的大规模人造居住结构)
53. <span id="气态行星推进器">**气态行星推进器**</span>([行星发动机](#行星发动机)的衍生技术，原理类似[卡普兰推进器](#卡普兰推进器)，通过直接从气态行星中吸收物质并经过反应产生能量，随后将物质从上下两侧喷出，从而推动气态行星)
54. <span id="行星级飞船">**行星级飞船**</span>
